package org.acoustixaudio.impulseresponse;
...
//                    AudioEngine.setPlaybackDeviceId(Integer.parseInt(newValue.toString()));
            ...
            Preference lamePreset = findPreference("format");
            lamePreset.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(@NonNull Preference preference) {
                    ...
                    AudioEngine.setLamePreset (Integer.parseInt(prefs.getString("format", "2")));
                    return false;
                }
            });
